...
def run_model(model, loss_fn, d, device='cuda:0', sw=None):
   ...
   # ONNx Inference
    ...
    total_metrics['mse0'] += mse0.item()
    total_metrics['mse_feat'] += mse_feat.item()
    total_metrics['mse_seg'] += mse_seg.item()
    total_metrics['mse_center'] += mse_center.item()
    total_metrics['mse_offset'] += mse_offset.item()
...
def main(
    ...
    print("mean mse0", total_metrics['mse0']/max_iters)
    print("mean mse_feat", total_metrics['mse_feat']/max_iters)
    print("mean mse_seg", total_metrics['mse_seg']/max_iters)
    print("mean mse_center", total_metrics['mse_center']/max_iters)
    print("mean mse_offset", total_metrics['mse_offset']/max_iters)
